...
class EnviarLoteNotasSincrono extends Factory
{
    public function render(
        ...
        $content ='';
        $method = "Rps";
        $content.='<EnviarLoteRpsSincronoEnvio xmlns:ns="http://www.w3.org/2000/09/xmldsig#" xmlns="http://www.abrasf.org.br/nfse.xsd">';
        ...
        $content.=    '<ListaRps>';
         ...
         $content .= '</ListaRps>';
         $content.=  '</LoteRps>';
         $content.=  '</EnviarLoteRpsSincronoEnvio>';
